  ...
  private static getSHACLFilesForProfile(profile: ValidationProfile): string[] {
    ...
    const processedUrls = shaclFiles.map((filePath: string) => {
      if (filePath.startsWith('https://raw.githubusercontent.com/')) {
        ...
        return `https://raw.githubusercontent.com/mjanez/metadata-quality-react/refs/heads/main/react-app/public/${filePath}`;
      }
    });
...
# Generated by shacl-engine and mjanez/metadata-quality-react
...
<urn:shacl:report:${report.profile}:${Date.now()}> a sh:ValidationReport ;
    ...
    foaf:homepage <https://github.com/mjanez/metadata-quality-react> ;
    rdfs:seeAlso <https://github.com/mjanez/metadata-quality-react?tab=readme-ov-file#metadata-quality-react> ;
